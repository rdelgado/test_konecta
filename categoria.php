            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="btn-group-vertical">
                        ...
                        <a href="categoria.php" title="" class="btn btn-secondary btn-lg" ref="categoria" role="button">Categorias</a>
                        ...
                        <table id="main" class="table table-striped">
                            ...
                            if(is_array($resCategoria) && sizeof($resCategoria) > 0){
                                ...
                                <tr>
                                    <td>" . $value["ID"] . "</td>
                                    <td>" . $value["nombre"]  . "</td>                                    
                                    <td><a href='javascript:void(0);' class='btn btn-warning btn-sm editCategoria'  data-bs-toggle='modal' data-bs-target='#editModal' rel='" . $value["ID"] . "' title='Editar categoria'>Editar</a><a href='javascript:void(0);' class='btn btn-danger btn-sm delCategoria' title='Eliminar categoria' rel='" . $value["ID"] . "'>Eliminar</a></td>
                                </tr>";
                                }
                                echo "</tbody>";
                            }
                    ...
                    <div class="modal" id="addModal">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                                <form class="was-validated" id="frmaddCategoria">
                                    <div class="mb-3 mt-3">
                                    ...
                                    <button type="button" class="btn btn-primary" id="saveCategoria">Guardar</button>
                                </form>
                            </div>
                    ...
                    <div class="modal" id="editModal">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <!-- Modal body -->
                                <div class="modal-body">
                                    <form class="was-validated" id="frmupdCategoria">
                                        <div class="mb-3 mt-3">
                                            <label for="nombre" class="form-label">Nombre:</label>
                                            <input type="text" class="form-control" id="nombre" placeholder="Ingrese el nombre" name="nombre" maxlength = "60" minlength = "3" pattern = "^[a-zA-Z0-9_.-]*$" required>
                                            <div class="valid-feedback">Valido</div>
                                        ...
                                        <button type="button" class="btn btn-primary" id="updCategoria">Guardar</button>
                                    </form>
                                </div>
